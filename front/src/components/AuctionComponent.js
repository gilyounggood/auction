  ...
  return (
    <>
      <BoxContent onClick={() => { history.push(`/auction/${props.pk}`) }}>
        ...
        <RightTextBox style={{ fontSize: '0.8rem', color: '#5a5a5a' }}>등록인 | <strong style={{ fontSize: '1rem', color: '#ababab' }}><img width="23px" src={setLevel(props.seller_reliability)}/>{props.seller_nickname}</strong></RightTextBox>
